...
setwd("/Users/anudhiisundaram/Desktop/Applications/Coding Samples /CAUSAL FOREST")
...
run_causal_forest <- function(data, outcome_var, treatment_var, covariate_vars) {
  ...
  ate_all <- ate_table(average_treatment_effect(cf), "All")
  ...
  stargazer(ate_summary_table, type = "html", out = stargazer_table_filename, 
            ...
            title = paste("Average Treatment Effect Estimates for", outcome_var))
